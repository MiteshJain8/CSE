...
public class P3MoviesDB {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3307/week3", USER = "root", PASS = ""; // Update this
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery(queryAllMovies);
            printResultSet(rs);
            ...
            preparedStatement.setString(2, "Morning Glory");
            preparedStatement.setString(3, "Rom-Com");
            preparedStatement.setFloat(4, 6.5f);
            preparedStatement.setInt(5, 2010);
            preparedStatement.executeUpdate();
            System.out.println("\nNew movie inserted successfully.");

            // Display all the details
            rs = statement.executeQuery(queryAllMovies);
            printResultSet(rs);

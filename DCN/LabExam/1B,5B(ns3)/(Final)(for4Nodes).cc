...
//4( copy and duplicate below 2 lines and make the changes as shown in next 6 lines)
...
//5(copy and duplicate below line and make the changes as shown in next 3 lines)
